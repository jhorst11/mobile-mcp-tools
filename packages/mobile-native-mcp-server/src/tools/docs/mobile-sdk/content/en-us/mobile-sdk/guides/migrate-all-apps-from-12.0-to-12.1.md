# Migrate All Apps from 12.0 to 12.1.1

Mobile SDK 12.1.1 migration is easiest if you use the Salesforce CLI plugin or the Mobile SDK npm scripts.

Before you begin upgrading, read about new 12.1.1 features in [What’s New in Mobile SDK 12.1.1](gs-whatsnew.md). Mobile SDK 12.1.1 requires no code changes.
...
- Native iOS (Swift, Objective-C)
  ...
  - :
    ...
    - Consider adopting new features. See [What’s New in Mobile SDK 12.1.1](gs-whatsnew.md).
