...
Before you begin upgrading, read about new 9.2 features in [What’s New in Mobile SDK 11.1](gs-whatsnew.md).
...
- Key Store Encryption Upgrade
  ...
  - : Mobile SDK 9.2 upgrades key store encryption. For most apps the upgrade happens automatically, but some apps require extra steps. See [Upgrading Encryption in Apps](auth-secure-key-storage-ios.md#ios-keystore-encryption-upgrading).
