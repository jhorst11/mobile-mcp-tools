...
Before you begin upgrading, read about new 12.0.1 features in [What’s New in Mobile SDK 12.0.1](gs-whatsnew.md). Mobile SDK 12.0.1 requires no code changes.
...
- Native iOS (Swift, Objective-C)
  ...
  - :
    ...
    - Consider adopting new features. See [What’s New in Mobile SDK 12.0.1](gs-whatsnew.md).
