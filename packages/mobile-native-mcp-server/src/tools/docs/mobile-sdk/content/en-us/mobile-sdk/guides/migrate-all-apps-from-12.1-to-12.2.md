# Migrate All Apps from 12.1 to 12.2

Mobile SDK 12.2 migration is easiest if you use the Salesforce CLI plugin or the Mobile SDK npm scripts.

Before you begin upgrading, read about new 12.2 features in [What’s New in Mobile SDK 12.2](gs-whatsnew.md).
...
- Native iOS (Swift, Objective-C)
  ...
  - :
    ...
    - Consider adopting new features. See [What’s New in Mobile SDK 12.2](gs-whatsnew.md).
