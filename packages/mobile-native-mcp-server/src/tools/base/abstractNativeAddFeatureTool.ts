 ...
 * sfmobile-native-add-feature workflow.
 *
 * This class automatically sets the orchestratorToolId to
 * 'sfmobile-native-add-feature' for all extending tools.
 */
export abstract class AbstractNativeAddFeatureTool<
...
> extends AbstractWorkflowTool<TMetadata> {
  constructor(
    ...
    super(server, toolMetadata, ADD_FEATURE_ORCHESTRATOR_TOOL.toolId, loggerComponentName, logger);
  }
}
