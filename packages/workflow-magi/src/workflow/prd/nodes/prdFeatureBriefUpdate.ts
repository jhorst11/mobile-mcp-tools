...
import type { FeatureBriefModification } from '../../../tools/prd/shared/featureBriefSchemas.js';
...
export class PRDFeatureBriefUpdateNode extends AbstractGuidanceNode<PRDState> {
  ...
  execute = (state: PRDState): Partial<PRDState> => {
    ...
    const guidanceData: NodeGuidanceData = {
      ...
      metadata: {
        nodeName: this.name,
        description: 'Update the feature brief based on review feedback',
      },
    };
  ...
  private generateFeatureBriefUpdateGuidance(
    ...
    reviewResult: { approved: boolean; modifications?: FeatureBriefModification[] }
  ): string {
