        ...
        messages: [
          {
            ...
            content: {
              type: 'text',
              text: `Check if the magen-sdd directory exists at the project root (this may be a hidden directory), if it does invoke the sfmobile-sdd-build-feature tool with the following arguments: featureid ${id}. Once the feature is scaffolded follow the provided instructions to build out the PRD.`,
            },
          },
        ],
      })
